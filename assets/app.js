...
function renderInvSlider() {
  ...
  track.innerHTML = INV_CARDS.map((c, i) => {
    const specs = [];
    if(c.beds) specs.push(`<span style="display:inline-flex;align-items:center;gap:3px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M2.5 18.5v-6a2 2 0 0 1 2-2h15a2 2 0 0 1 2 2v6"/><path d="M2.5 18.5h19"/><path d="M5.5 10.5V8a1.5 1.5 0 0 1 1.5-1.5h10A1.5 1.5 0 0 1 18.5 8v2.5"/><path d="M4 18.5v2M20 18.5v2"/></svg><span style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:12px;color:rgba(255,255,255,0.9)">${c.beds}</span><span style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:9px;letter-spacing:0.13em;text-transform:uppercase;color:rgba(255,255,255,0.6)">Bedrooms</span></span>`);
    if(c.baths) specs.push(`<span style="display:inline-flex;align-items:center;gap:3px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12.5h18v2.5a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4v-2.5Z"/><path d="M6.5 12.5V6.2A2.2 2.2 0 0 1 8.7 4h.1a2.2 2.2 0 0 1 2.2 2.2"/><path d="M9.4 6.6h2.6"/><path d="M7.5 19.5 6.5 21M16.5 19.5l1 1.5"/></svg><span style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:12px;color:rgba(255,255,255,0.9)">${c.baths}</span><span style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:9px;letter-spacing:0.13em;text-transform:uppercase;color:rgba(255,255,255,0.6)">Bathrooms</span></span>`);
    if(c.sqm) specs.push(`<span style="display:inline-flex;align-items:center;gap:3px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.9)" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 10.6 9-7.1 9 7.1"/><path d="M5.4 9.2V20a.8.8 0 0 0 .8.8h11.6a.8.8 0 0 0 .8-.8V9.2"/><path d="M10 20.8v-5h4v5"/></svg><span style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:12px;color:rgba(255,255,255,0.9)">${c.sqm}</span><span style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:9px;letter-spacing:0.13em;text-transform:uppercase;color:rgba(255,255,255,0.6)">sqm</span></span>`);
      ...
      <div class="inv-card-img">
        ...
        <div class="inv-card-over">
          ...
          <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,0.15);display:flex;align-items:baseline;justify-content:space-between;">
            <span class="inv-card-price" style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:20px;font-weight:600;letter-spacing:-0.01em;white-space:nowrap;">${c.price}</span>
            <span class="inv-card-loc" style="font-family:'Figtree','Noto Sans Thai',sans-serif;font-size:8.5px;letter-spacing:0.18em;text-transform:uppercase;color:rgba(255,255,255,0.55);text-align:right;">${c.loc}</span>
          </div>
        </div>
      </div>
    </div>
